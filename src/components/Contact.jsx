  ...
  return (
    <div className="text-center align-items-center contactdiv container">
      ...
      <div className="row socialpack">
        ...
        <div className="col-3  socialdiv">
          <a href="https://www.instagram.com/behove_is_quirk/" target="_blank" rel="noreferrer">
            <FaSquareInstagram />
          </a>
          <h5>Instagram</h5>
        </div>
        <div className="col-3  socialdiv">
          <a href="swati2003mry@gmail.com" target="_blank" rel="noreferrer">
            <FaEnvelope />
          </a>
        ...
        <div className="col-3 socialdiv">
          <a href="https://github.com/swatimry" target="_blank" rel="noreferrer">
            <FaSquareGithub />
          </a>
          <h5>Github</h5>
        </div>
